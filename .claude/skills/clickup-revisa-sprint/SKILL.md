...
> pode **não** estar presente. Se o run agendado falhar na verificação de conector, trate o agendamento como
> um lembrete para executar `/clickup-revisa-sprint run [squad]` manualmente.
