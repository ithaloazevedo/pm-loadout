---
name: checar-usabilidade
description: "Evaluate user-facing interfaces against Nielsen's 10 Usability Heuristics. Complements /mycelium:checar-servico (Downe = service-level quality, Nielsen = interface-level quality)."
---
